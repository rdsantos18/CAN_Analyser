...
#define LED_RS485_RX_Pin GPIO_PIN_0
#define LED_RS485_RX_GPIO_Port GPIOC
#define LED_CAN2_RX_Pin GPIO_PIN_1
#define LED_CAN2_RX_GPIO_Port GPIOC
#define LED_CAN1_RX_Pin GPIO_PIN_2
...
#define LED_CAN2_TX_Pin GPIO_PIN_0
#define LED_CAN2_TX_GPIO_Port GPIOB
#define LED_485_TX_Pin GPIO_PIN_1
